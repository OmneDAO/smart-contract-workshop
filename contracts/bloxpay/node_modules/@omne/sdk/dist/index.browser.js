...
const fallbackProviders = {
    ...
    env: {
        ...
        isNode() {
            return typeof browser$1 !== 'undefined' && !!browser$1.versions?.node;
        }
    }
};
...
function assertWebCrypto() {
    ...
    return cryptoAny.subtle;
}
function createBrowserWebSocket(url, handlers) {
    const WebSocketCtor = globalThis.WebSocket;
    if (typeof WebSocketCtor !== 'function') {
...
async function runWebCrypto(mode, keyBytes, ivBytes, data) {
...
function createBrowserPlatformProviders() {
    return {
        fetch: {
            async getFetch() {
                if (typeof globalThis.fetch !== 'function') {
...
async function resolveCrypto() {
    ...
    const nodeCrypto = await Promise.resolve().then(function () { return empty; });
...
async function readFileBytes(filePath) {
    ...
    const fs = await Promise.resolve().then(function () { return empty; });
